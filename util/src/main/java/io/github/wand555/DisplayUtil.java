...
public class DisplayUtil {
    ...
    public static void showVectorRepeat(Vector toShow, Vector offsetFromOrigin, int amount, Color color, boolean tip, World world, JavaPlugin plugin) {
        Bukkit.getScheduler().runTaskTimer(plugin, () -> showVector(toShow, offsetFromOrigin, amount, color, tip, world), 0L, 5L);
    }
}
